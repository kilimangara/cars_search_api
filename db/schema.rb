...
ActiveRecord::Schema.define(version: 2022_04_23_211553) do
  ...
  create_table "user_cars_scorings", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "car_id", null: false
    t.decimal "scoring", precision: 4, scale: 3, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["car_id", "user_id"], name: "index_user_cars_scorings_on_car_id_and_user_id", unique: true
  end
